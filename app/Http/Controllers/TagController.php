...
class TagController extends Controller
{
    ...
    {
        $tags = Tag::all();
        return view('cssp.tags.index')->with('tags',$tags);
    }
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('success', 'สร้างแท็กใหม่');
    ...
    {
        $tag = Tag::find($id);
        return view('cssp.tags.show')->with('tag',$tag);
    }
    ...
    {
        $tag = Tag::find($id);
        return view('cssp.tags.edit')->with('tag',$tag);
    }
