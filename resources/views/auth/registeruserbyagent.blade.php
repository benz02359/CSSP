...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="card-header" style="font-size: 22px;background-color: #343A40;color:aliceblue"><b>เพิ่มผู้ใช้งาน</b></div>
                <div class="card-body" style="background-color: #FFF;">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <input id="companyid" type="hidden" name="company_id" value=" {{ Auth::user()->company_id }} ">   
